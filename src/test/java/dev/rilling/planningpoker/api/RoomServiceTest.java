...
class RoomServiceTest {
	...
	void editExtensionsAddsExtension() {
		...
		Assertions.assertThat(room.getExtensionConfigs()).extracting(RoomExtensionConfig::getExtension).containsExactly(someExtension);
	}
	...
	void editExtensionsRemovesExtension() {
		...
		Assertions.assertThat(room.getExtensionConfigs()).isEmpty();
	}
	...
	void editExtensionsMixedExtensionChanges() {
		...
		Assertions.assertThat(room.getExtensionConfigs()).extracting(RoomExtensionConfig::getExtension).containsExactly(otherExtension);
	}
