...
class RoomControllerIT {
	...
	void getRooms() throws Exception {
		...
		mockMvc.perform(get("/api/rooms").with(MockOidcLogins.bobOidcLogin()))
	...
	void createRoomDuplicateName() throws Exception {
		...
		mockMvc.perform(post("/api/rooms/my-room").with(MockOidcLogins.bobOidcLogin()).with(csrf()).contentType(MediaType.APPLICATION_JSON).content("""
				{
					"cardSetName": "My Set"
				}
	...
	void deleteRoomUnknownName() throws Exception {
		...
		mockMvc.perform(delete("/api/rooms/my-room").with(MockOidcLogins.bobOidcLogin()).with(csrf())).andExpect(status().isNotFound());
	}
	...
	void deleteRoomDeletes() throws Exception {
		...
		mockMvc.perform(delete("/api/rooms/my-room").with(MockOidcLogins.bobOidcLogin()).with(csrf())).andExpect(status().isOk());
	...
	void editRoomUnknownName() throws Exception {
		...
		mockMvc.perform(patch("/api/rooms/my-room").with(MockOidcLogins.bobOidcLogin()).with(csrf()).contentType(MediaType.APPLICATION_JSON).content("""
				{
					"cardSetName": "My Set"
				}
	...
	void loadRoomUnknownName() throws Exception {
		...
		mockMvc.perform(get("/api/rooms/my-room/").with(MockOidcLogins.bobOidcLogin())).andExpect(status().isNotFound());
	}
	...
	void loadRoomNotMember() throws Exception {
		...
		mockMvc.perform(get("/api/rooms/my-room/").with(MockOidcLogins.bobOidcLogin())).andExpect(status().isForbidden());
	}
	...
	void loadRoomLoads() throws Exception {
		...
		mockMvc.perform(get("/api/rooms/my-room/").with(MockOidcLogins.bobOidcLogin()))
				.andExpect(status().isOk())
